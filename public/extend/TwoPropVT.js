...
var TwoPropVT = function(sceneManager, id){
	this.sceneManager = sceneManager;
	this.setId(id);
	this._color = '#FE642E';
	var width = 256;
	this._canvasSize = {'width': width, height: 256};
...
mono.extend(TwoPropVT,Object,{
	...
	init: function(text){
	    ...
	    billboard.setScale(c.width/3, c.height/3, 1);
	...
	updateTable: function(data, id){
		...
		$('div:nth-child(even) > span:nth-child(1)',$table).css({
			fontSize: '40px',
		});
		$('div',$table).css({
			margin: '-10px 0',
...
it.viewTemplate.TwoPropVT = TwoPropVT;