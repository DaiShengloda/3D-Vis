...
mono.extend($UColorSettingPanel, $ConfigApp, {
    ...
    //      var option = $('<option value="' + prex + '_blue">蓝色</option>');
    //      select.append(option);
    //      option = $('<option value="' + prex + '_green">绿色</option>');
    //      select.append(option);
    //      option = $('<option value="' + prex + '_yellow">黄色</option>');
    //      select.append(option);
    //      option = $('<option value="' + prex + '_red">红色</option>');
    //      select.append(option);
    //      return select;
    //  },
    ...
    initConfigPanel: function() {
        var box = $('<div class="temperatureBox" id="uColorSettingPanel"><div>');
    ...
    clickForConfirm: function() {
        ...
        ServerUtil.api('config', 'update', objData, function(data) {
            if (data.error) {
                ...
                main.systemConfig.u_color_config = formData;
            }
        });
    },
