...
var $TemperatureAndHumidityConfigPanel = function(configDialog) {
    // this.configDialog = $('<div id="temperatureAndHumidityConfigDialog" style = "display: none"></div>');
    // this.container = $('#container');
    // this.container.append(this.configDialog);
...
mono.extend($TemperatureAndHumidityConfigPanel, $ConfigApp, {
    ...
    createPicChoose:function(type){
        ...
        var picsty=this.createImgClass("./images/tem_blue.png","./images/tem_green.png","./images/tem_yellow.png","./images/tem_red.png","80%","20%");
        picbox.append(picsty);
        picsty=this.createImgClass("./images/hum_blue.png","./images/hum_green.png","./images/hum_yellow.png","./images/hum_red.png","80%","20%");
        picbox.append(picsty);
    ...
    clickForSetDefaultValue: function() {
        var formData = this.getFormData();
        var defaultTemp=["#000000",40,"microsoft yahei",4,true,false,204,430,75,220,104,230,"./images/tem_blue.png","./images/tem_green.png","./images/tem_yellow.png","./images/tem_red.png"];
        var defaultHum=["#000000",50,"microsoft yahei",5,true,false,318,442,100,300,150,200,"./images/hum_blue.png","./images/hum_green.png","./images/hum_yellow.png","./images/hum_red.png"];
    ...
    clickForConfirm: function() {
        ...
        ServerUtil.api('config', 'update', objData, function(data) {
            if (data.error) {
                ...
                main.systemConfig.temp_alarm_config = formData.tempBasic;
                main.systemConfig.hum_alarm_config = formData.humBasic;
                main.systemConfig.temp_more_config = formData.tempMore;
                main.systemConfig.hum_more_config = formData.humMore;

                var apps = main.navBarManager.appManager.appMaps;
                if (apps.TEMP && apps.TEMP.app) {
                    apps.TEMP.app.bgMap = main.systemConfig.temp_alarm_config;
                    apps.TEMP.app.bgMapMore = main.systemConfig.temp_more_config;
                }
                if (apps.HUMIDITY && apps.HUMIDITY.app) {
                    apps.HUMIDITY.app.bgMap = main.systemConfig.hum_alarm_config;
                    apps.HUMIDITY.app.bgMapMore = main.systemConfig.hum_more_config;
                }
                // self.configDialog.dialog('close');
            }
        });
    },
